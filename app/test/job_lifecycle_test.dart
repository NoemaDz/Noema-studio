...
void main() {
  ...
  group('Job Lifecycle', () {
    test('Job starts from pending and transitions correctly to completed', () async {
      final job = Job(id: '1', providerId: 'mock_provider', type: 'image', status: JobStatus.pending);
      manager.add(job);
    ...
    test('Completed cannot be cancelled or transitioned', () {
      final job = Job(id: '1', providerId: 'mock_provider', type: 'image', status: JobStatus.completed);
      manager.add(job);
    ...
    test('Cancelled cannot transition to completed', () {
      final job = Job(id: '1', providerId: 'mock_provider', type: 'image', status: JobStatus.cancelled);
      manager.add(job);
    ...
    test('Failed cannot transition to completed', () {
      final job = Job(id: '1', providerId: 'mock_provider', type: 'image', status: JobStatus.failed);
      manager.add(job);
